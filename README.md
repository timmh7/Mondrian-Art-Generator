This program generates art similar to the artist Piet Mondrian.
Run "Client.java" to begin generating your art.
You will be prompted to specify if you want a "basic" or "complex" version.
